...
function set_voice_output()
  ...
  for i = 1, 2 do
    ...
    if params:get("voice_out"..i) == 5 then
      count = count + 1
    end
  end
  if count > 0 then
...
function event_exec(e)
  if e.t == eINT then
    if not mute_int then
      local note_num = scale_notes[e.note]
...
function init()
  ...
  params:add_option("pattern_quant", "pattern quantization", options.pattern_quant, 8)
  ...
  norns.crow.add = function()
    --norns.crow.init() -- this initalized crow and norns part of crow
  ...
  if z == 1 then
    ...
    elseif y == 3 then
      ...
      elseif x > 7 and x < 10 and not set_pattern then
        local e = {t = eINT, i = int_focus, note = tab.key(scale_notes, params:get("root_note"))} event(e)
        notes.last = e.note
      end
    elseif y == 4 then
      -- interval octave up
    ...
    elseif (y == 7 or y == 8) and x > 2 and x < 15 then
      ...
      if tab.key(scale_notes, new_note) ~= nil then
...
function gridredraw()
  ...
  for i = 1, 8 do
    if set_pattern then
      g:led(i + 4, 1, pattern[i].synced and 8 or 2)
      g:led(i + 4, 2, pattern[i].count_in_num == 1 and 2 or 4)
      g:led(i + 4, 3, params:get("pattern_length") == i and 15 or 4)
      g:led(i + 4, 4, params:get("pattern_quant") == i and 15 or 2)
    else
      if pattern[i].rec == 1 then
        g:led(i + 4, 1, 15)
      elseif pattern[i].overdub == 1 then
  ...
  local root = params:get("root_note") % 12 + 24
  for i = 7, 8 do
    g:led(3, i, root == 24 and 15 or (lookup(24) and 10 or 0))  -- C
    g:led(4, i, root == 25 and 15 or (lookup(25) and 10 or 0)) -- C#
    g:led(5, i, root == 26 and 15 or (lookup(26) and 10 or 0)) -- D
    g:led(6, i, root == 27 and 15 or (lookup(27) and 10 or 0)) -- D#
    g:led(7, i, root == 28 and 15 or (lookup(28) and 10 or 0)) -- E
    g:led(8, i, root == 29 and 15 or (lookup(29) and 10 or 0)) -- F
    g:led(9, i, root == 30 and 15 or (lookup(30) and 10 or 0)) -- F#
    g:led(10, i, root == 31 and 15 or (lookup(31) and 10 or 0)) -- G
    g:led(11, i, root == 32 and 15 or (lookup(32) and 10 or 0)) -- G#
    g:led(12, i, root == 33 and 15 or (lookup(33) and 10 or 0)) -- A
    g:led(13, i, root == 34 and 15 or (lookup(34) and 10 or 0)) -- A#
    g:led(14, i, root == 35 and 15 or (lookup(35) and 10 or 0)) -- B
  end
  -- key link
