...
function Thebangs.synth_params()
  ...
  --params:add_separator("bangs_synth_params", "synth parameters")
...
function Thebangs.voice_params()

  --params:add_separator("bangs_voice_params", "voice parameters")
  ...
  params:set_action("steal_index", function(x) engine.stealIndex(x) end)
