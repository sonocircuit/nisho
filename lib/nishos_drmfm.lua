...
function drmfm.paste_voice(voice)
  local voice = voice or selected_voice
  for _,v in ipairs(param_list) do 
...
function drmfm.add_params()
  ...
  params:set_action("drmfm_copy_params", function() drmfm.copy_voice() end)

  params:add_binary("drmfm_paste_params", "< paste voice", "trigger")
  params:set_action("drmfm_paste_params", function() drmfm.paste_voice() end)
  ...
  params:set_action("drmfm_trig", function() drmfm.trig() end)
